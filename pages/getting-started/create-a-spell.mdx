...
Building your first spell in Magick is a straightforward process. In this guide, we'll walk through creating a simple spell that responds to incoming messages with generated text. If you need tips for great prompt engineering, check out this [Prompting Guide](https://www.promptingguide.ai/).
